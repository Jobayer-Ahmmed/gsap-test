...
const Projects = () => {
  ...
  return (
    <div className="text-gray-500 text-sm container mx-auto lg:px-8 px-4 flex justify-between items-start mt-16">
      <div className="flex justify-center items-center gap-3 uppercase">
        <p>Featured Work</p>
        <p>·</p>
        <p>
          <span className="mr-2">3</span> projects
        </p>
      </div>
      <div className="lg:w-3/5 ">
        <div ref={cursorParentRef} id="cursorParentDiv" className="relative w-full">
          ...
          >
            <source src={projects} type="video/mp4" />
          </video>
        </div>
